...
/**
 ** \file /home/ubuntu/proj/src/parser.hh
...
#ifndef YY_YY_HOME_UBUNTU_PROJ_SRC_PARSER_HH_INCLUDED
# define YY_YY_HOME_UBUNTU_PROJ_SRC_PARSER_HH_INCLUDED
...
#line 55 "/home/ubuntu/proj/src/parser.hh"
...
namespace yy {
#line 189 "/home/ubuntu/proj/src/parser.hh"
...
# if 201103L <= YY_CPLUSPLUS
   ...
   private:
    ...
    union union_type {
      // binary_operation
      char dummy1[sizeof(BinaryOperation *)];

      // class_declaration
      char dummy2[sizeof(ClassDeclaration *)];

      // class_declaration_list
      char dummy3[sizeof(ClassDeclarationList *)];
      ...
      // formal
      char dummy8[sizeof(Formal *)];

      // formals
      char dummy9[sizeof(Formals *)];

      // identifier
      char dummy10[sizeof(Identifier *)];

      // number
      char dummy11[sizeof(IntegerLiteral *)];

      // local_variable_declaration
      char dummy12[sizeof(LocalVariableDeclaration *)];

      // lvalue
      char dummy13[sizeof(Lvalue *)];

      // main_class
      char dummy14[sizeof(MainClass *)];

      // method_declaration
      char dummy15[sizeof(MethodDeclaration *)];

      // method_invocation
      char dummy16[sizeof(MethodInvocation *)];

      // unit
      char dummy17[sizeof(Program *)];

      // stmt
      char dummy18[sizeof(Statement *)];

      // stmt_list
      char dummy19[sizeof(StatementList *)];

      // variable_declaration
      char dummy20[sizeof(VariableDeclaration *)];
      ...
      // array_type
      char dummy23[sizeof(types::ArrayType *)];

      // simple_type
      char dummy24[sizeof(types::SimpleType *)];

      // type
      char dummy25[sizeof(types::Type *)];
    };
  ...
  struct basic_symbol : Base {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    basic_symbol(typename Base::kind_type t, types::ArrayType *&&v, location_type &&l)
        : Base(t), value(std::move(v)), location(std::move(l)) {}
#else
    basic_symbol (typename Base::kind_type t, const types::ArrayType*& v, const location_type& l)
      : Base (t)
      , value (v)
      , location (l)
    {}
#endif
#if 201103L <= YY_CPLUSPLUS
    basic_symbol(typename Base::kind_type t, types::SimpleType *&&v, location_type &&l)
        : Base(t), value(std::move(v)), location(std::move(l)) {}
#else
    basic_symbol (typename Base::kind_type t, const types::SimpleType*& v, const location_type& l)
      : Base (t)
      , value (v)
      , location (l)
    {}
#endif
#if 201103L <= YY_CPLUSPLUS
    basic_symbol(typename Base::kind_type t, types::Type *&&v, location_type &&l)
        : Base(t), value(std::move(v)), location(std::move(l)) {}
#else
    basic_symbol (typename Base::kind_type t, const types::Type*& v, const location_type& l)
      : Base (t)
      , value (v)
      , location (l)
    {}
    ...
    void clear() {
      ...
      switch (yytype) {
        ...
        case 65: // array_type
          value.template destroy<types::ArrayType *>();
          break;

        case 64: // simple_type
          value.template destroy<types::SimpleType *>();
          break;

        case 63: // type
          value.template destroy<types::Type *>();
          break;
  ...
  struct symbol_type : basic_symbol<by_type> {
    ...
    symbol_type(int tok, location_type l)
        : super_type(token_type(tok), std::move(l)) {
          YY_ASSERT (
          tok == token::TOK_END || tok == token::TOK_EOL || tok == token::TOK_ASSIGN || tok == token::TOK_MINUS
              || tok == token::TOK_PLUS || tok == token::TOK_STAR || tok == token::TOK_SLASH || tok == token::TOK_LPAREN
              || tok == token::TOK_RPAREN || tok == token::TOK_LBRACE || tok == token::TOK_RBRACE
              || tok == token::TOK_CLASS || tok == token::TOK_PUBLIC || tok == token::TOK_STATIC
              || tok == token::TOK_VOID || tok == token::TOK_MAIN || tok == token::TOK_SOUT
              || tok == token::TOK_SEMICOLON || tok == token::TOK_INT || tok == token::TOK_BOOLEAN
              || tok == token::TOK_LENGTH || tok == token::TOK_POINT || tok == token::TOK_EXTENDS
              || tok == token::TOK_COMMA || tok == token::TOK_LSBRACE || tok == token::TOK_RSBRACE
              || tok == token::TOK_ASSERT || tok == token::TOK_IF || tok == token::TOK_ELSE || tok == token::TOK_WHILE
              || tok == token::TOK_RETURN || tok == token::TOK_NEW || tok == token::TOK_THIS || tok == token::TOK_TRUE
              || tok == token::TOK_FALSE || tok == token::TOK_GT || tok == token::TOK_LT || tok == token::TOK_AND
              || tok == token::TOK_OR || tok == token::TOK_EQ || tok == token::TOK_MOD || tok == 298 || tok == 299);
    }
#else
  ...
  make_POINT(location_type l) {
    return symbol_type(token::TOK_POINT, std::move(l));
  }
#else
  static
  symbol_type
...
parser::basic_symbol<Base>::basic_symbol(basic_symbol &&that)
  ...
  switch (this->type_get()) {
    ...
    case 65: // array_type
      value.move<types::ArrayType *>(std::move(that.value));
      break;

    case 64: // simple_type
      value.move<types::SimpleType *>(std::move(that.value));
      break;

    case 63: // type
      value.move<types::Type *>(std::move(that.value));
      break;
...
parser::basic_symbol<Base>::basic_symbol(const basic_symbol &that)
  ...
  switch (this->type_get()) {
    ...
    case 65: // array_type
      value.copy<types::ArrayType *>(YY_MOVE(that.value));
      break;

    case 64: // simple_type
      value.copy<types::SimpleType *>(YY_MOVE(that.value));
      break;

    case 63: // type
      value.copy<types::Type *>(YY_MOVE(that.value));
      break;
...
parser::basic_symbol<Base>::move(basic_symbol &s) {
  ...
  switch (this->type_get()) {
    ...
    case 65: // array_type
      value.move<types::ArrayType *>(YY_MOVE(s.value));
      break;

    case 64: // simple_type
      value.move<types::SimpleType *>(YY_MOVE(s.value));
      break;

    case 63: // type
      value.move<types::Type *>(YY_MOVE(s.value));
      break;
...
#line 2623 "/home/ubuntu/proj/src/parser.hh"

#endif // !YY_YY_HOME_UBUNTU_PROJ_SRC_PARSER_HH_INCLUDED
