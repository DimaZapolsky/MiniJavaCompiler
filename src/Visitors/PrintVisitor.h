...
#ifndef NAIVEINTERPRETER_SRC_VISITORS_PRINTVISITOR_H_
#define NAIVEINTERPRETER_SRC_VISITORS_PRINTVISITOR_H_
...
class PrintVisitor : public BaseVisitor {
 public:
  explicit PrintVisitor(const std::string &file_path);
...
#endif //NAIVEINTERPRETER_SRC_VISITORS_PRINTVISITOR_H_
